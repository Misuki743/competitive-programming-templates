...
data:
  ...
  bundledCode: "#line 1 \"poly/convolution_arbitrary_mod.cpp\"\n//reference: https://math314.hateblo.jp/entry/2015/05/07/014908\n\
    ...
    \ = a[i].get(), a1[i] = a[i].get(), a2[i] = a[i].get();\n  for(int i = 0; i <\
...
layout: document
redirect_from:
- /library/poly/convolution_arbitrary_mod.cpp
- /library/poly/convolution_arbitrary_mod.cpp.html
