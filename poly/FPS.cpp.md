...
data:
  ...
  bundledCode: "#line 1 \"poly/FPS.cpp\"\n//#include \"modint/Montgomery_modint.cpp\"\
    ...
    \ composition inverse of g(x) (i.e. f(g(x)) = x) and [x^0]f(x) = [x^0]g(x) = 0,\
    \ [x^1]f(x) != 0, [x^1]g(x) != 0, then\n//  [x^n]g(x)^k = k/n [x^{n - k}] (x /\
  ...
  code: "//#include \"modint/Montgomery_modint.cpp\"\n//#include \"poly/NTT.cpp\"\n\
    \n//lagrange inversion formula:\n//  let f(x) be composition inverse of g(x) (i.e.\
    \ f(g(x)) = x) and [x^0]f(x) = [x^0]g(x) = 0, [x^1]f(x) != 0, [x^1]g(x) != 0,\
