...
data:
  ...
  - name: acted_monoid
    ...
    - icon: ':warning:'
      path: acted_monoid/set_max.cpp
      title: acted_monoid/set_max.cpp
    - icon: ':warning:'
      path: acted_monoid/set_min.cpp
      title: acted_monoid/set_min.cpp
    - icon: ':warning:'
      path: acted_monoid/set_sum.cpp
      title: acted_monoid/set_sum.cpp
  - name: combi
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: ds
    ...
    - icon: ':warning:'
      path: ds/line_container.cpp
      title: ds/line_container.cpp
    - icon: ':warning:'
      path: ds/pbds_set.cpp
      title: ds/pbds_set.cpp
    - icon: ':warning:'
      path: ds/persistent_treap.cpp
      title: ds/persistent_treap.cpp
    - icon: ':warning:'
  ...
  - name: geometry
    ...
    - icon: ':warning:'
      path: geometry/dynamic_hull.cpp
      title: geometry/dynamic_hull.cpp
    - icon: ':warning:'
  ...
  - name: graph/functional_graph
    pages:
    - icon: ':warning:'
      path: graph/functional_graph/func_graph.cpp
      title: graph/functional_graph/func_graph.cpp
    - icon: ':warning:'
      path: graph/functional_graph/functional_graph_distance.cpp
      title: graph/functional_graph/functional_graph_distance.cpp
  - name: graph/matching
    pages:
    - icon: ':heavy_check_mark:'
      path: graph/matching/Hopcroft_Karp.cpp
      title: graph/matching/Hopcroft_Karp.cpp
    - icon: ':heavy_check_mark:'
  ...
  - name: graph/misc
    ...
    - icon: ':heavy_check_mark:'
      ...
      title: graph/misc/complement_connectivity.cpp
    - icon: ':heavy_check_mark:'
      path: graph/misc/cycle_detection.cpp
      title: graph/misc/cycle_detection.cpp
    - icon: ':heavy_check_mark:'
  ...
  - name: poly
    ...
    - icon: ':heavy_check_mark:'
      ...
      title: poly/power_projection.cpp
    - icon: ':warning:'
  ...
  - name: segtree
    ...
    - icon: ':warning:'
      path: segtree/segment_tree_2D.cpp
