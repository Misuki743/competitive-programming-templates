...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/functional_graph/functional_graph_distance.cpp\"\n\
    struct functional_graph_distance {\n  int n;\n  vector<int> ccId, dep, treeId,\
    \ l, tin, tout, cycSize;\n  vector<bool> onCycle;\n  functional_graph_distance(vector<int>\
    ...
    \    }\n  }\n};\n"
  code: "struct functional_graph_distance {\n  int n;\n  vector<int> ccId, dep, treeId,\
    \ l, tin, tout, cycSize;\n  vector<bool> onCycle;\n  functional_graph_distance(vector<int>\
    \ f) : n(ssize(f)), ccId(n, -1), \n  dep(n), treeId(n, -1), l(n), tin(n), tout(n),\
    \ cycSize(n), onCycle(n, false) {\n    vector<vector<int>> g(n);\n    for(int\
    \ i = 0; i < n; i++) {\n      g[f[i]].emplace_back(i);\n      g[i].emplace_back(f[i]);\n\
  ...
  verifiedWith: []
documentation_of: graph/functional_graph/functional_graph_distance.cpp
layout: document
redirect_from:
- /library/graph/functional_graph/functional_graph_distance.cpp
- /library/graph/functional_graph/functional_graph_distance.cpp.html
