...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/connectivity/BCC.cpp\"\nstruct BCC {\n  vector<int>\
...
documentation_of: graph/connectivity/BCC.cpp
layout: document
redirect_from:
- /library/graph/connectivity/BCC.cpp
- /library/graph/connectivity/BCC.cpp.html
