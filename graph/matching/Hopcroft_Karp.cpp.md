...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/matching/Hopcroft_Karp.cpp\"\n//source: KACTL\n\n\
    /**\n * Author: Chen Xing\n * Date: 2009-10-13\n * License: CC0\n * Source: N/A\n\
    \ * Description: Fast bipartite matching algorithm. Graph $g$ should be a list\n\
    \ * of neighbors of the left partition, and $btoa$ should be a vector full of\n\
    \ * -1's of the same size as the right partition. Returns the size of\n * the\
    \ matching. $btoa[i]$ will be the match for vertex $i$ on the right side,\n *\
    ...
    \ + 1, g, btoa, A, B))\n      return btoa[b] = a, 1;\n  }\n  return 0;\n}\n\n\
    int Hopcroft_Karp(vector<vi>& g, vi& btoa) {\n  int res = 0;\n  vi A(g.size()),\
...
documentation_of: graph/matching/Hopcroft_Karp.cpp
layout: document
redirect_from:
- /library/graph/matching/Hopcroft_Karp.cpp
- /library/graph/matching/Hopcroft_Karp.cpp.html
