...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/matching/minimum_vertex_cover.cpp\"\n//#include<graph/hopcroftKarp.cpp>\n\
...
layout: document
redirect_from:
- /library/graph/matching/minimum_vertex_cover.cpp
- /library/graph/matching/minimum_vertex_cover.cpp.html
