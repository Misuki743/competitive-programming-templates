...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/matching/minimumVertexCover.cpp\"\n//#include<graph/hopcroftKarp.cpp>\n\
  ...
  verifiedWith: []
documentation_of: graph/matching/minimumVertexCover.cpp
layout: document
redirect_from:
- /library/graph/matching/minimumVertexCover.cpp
- /library/graph/matching/minimumVertexCover.cpp.html
