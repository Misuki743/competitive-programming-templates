...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/misc/steinerTree.cpp\"\ntemplate<class T>\npair<T,\
    \ vector<int>> steiner_tree(int n, vector<int> s, vector<tuple<int, int, T>> e)\
...
documentation_of: graph/misc/steinerTree.cpp
layout: document
redirect_from:
- /library/graph/misc/steinerTree.cpp
- /library/graph/misc/steinerTree.cpp.html
