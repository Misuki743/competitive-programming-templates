...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/misc/eulerian_trail.cpp\"\ntemplate<bool directed\
    \ = false, bool circuit = false>\narray<vector<int>, 2> eulerian_trail(int n,\
  ...
  code: "template<bool directed = false, bool circuit = false>\narray<vector<int>,\
    \ 2> eulerian_trail(int n, vector<array<int, 2>> &e) {\n  vector<int> indeg(n),\
...
documentation_of: graph/misc/eulerian_trail.cpp
layout: document
redirect_from:
- /library/graph/misc/eulerian_trail.cpp
- /library/graph/misc/eulerian_trail.cpp.html
