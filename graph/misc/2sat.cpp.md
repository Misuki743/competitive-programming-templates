...
data:
  ...
  bundledCode: "#line 1 \"graph/misc/2sat.cpp\"\n//source: KACTL\n\n/**\n * Author:\
    \ Emil Lenngren, Simon Lindholm\n * Date: 2011-11-29\n * License: CC0\n * Source:\
    \ folklore\n * Description: Calculates a valid assignment to boolean variables\
    \ a, b, c,... to a 2-SAT problem, so that an expression of the type $(a\\|\\|b)\\\
    &\\&(!a\\|\\|c)\\&\\&(d\\|\\|!b)\\&\\&...$ becomes true, or reports that it is\
    \ unsatisfiable.\n * Negated variables are represented by bit-inversions (\\texttt{\\\
    tilde{}x}).\n * Usage:\n *  TwoSat ts(number of boolean variables);\n *  ts.either(0,\
    \ \\tilde3); // Var 0 is true or var 3 is false\n *  ts.setValue(2); // Var 2\
    \ is true\n *  ts.atMostOne({0,\\tilde1,2}); // <= 1 of vars 0, \\tilde1 and 2\
