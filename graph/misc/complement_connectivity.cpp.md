...
data:
  ...
  bundledCode: "#line 1 \"graph/misc/complement_connectivity.cpp\"\npair<vector<vector<int>>,\
    \ vector<int>> complement_connectivity(vector<vector<int>> &g) {\n  int n = ssize(g);\n\
  ...
  code: "pair<vector<vector<int>>, vector<int>> complement_connectivity(vector<vector<int>>\
    \ &g) {\n  int n = ssize(g);\n  vector<bool> vis(n, false), adj(n, false);\n \
...
layout: document
redirect_from:
- /library/graph/misc/complement_connectivity.cpp
- /library/graph/misc/complement_connectivity.cpp.html
