...
data:
  ...
  bundledCode: "#line 1 \"graph/misc/maximum_independent_set.cpp\"\nvector<int> maximum_independent_set(vector<ull>\
    ...
    \ - 1, 0, 0, dfs);\n\n  vector<int> mis;\n  for(int v = 0; v < n; v++)\n    if\
    \ (best >> v & 1)\n      mis.emplace_back(v);\n\n  return mis;\n}\n"
  code: "vector<int> maximum_independent_set(vector<ull> g, int n) {\n  vector<unsigned>\
...
layout: document
redirect_from:
- /library/graph/misc/maximum_independent_set.cpp
- /library/graph/misc/maximum_independent_set.cpp.html
