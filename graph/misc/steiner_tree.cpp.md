...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/misc/steiner_tree.cpp\"\ntemplate<class T>\npair<T,\
  ...
  verifiedWith: []
documentation_of: graph/misc/steiner_tree.cpp
layout: document
redirect_from:
- /library/graph/misc/steiner_tree.cpp
- /library/graph/misc/steiner_tree.cpp.html
