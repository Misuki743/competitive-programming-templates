...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/misc/cycle_detection.cpp\"\ntemplate<bool directed\
    \ = false>\narray<vector<int>, 2> cycle_detection(vector<array<int, 2>> &e) {\n\
    ...
    \    return false;\n  };\n\n  for(int v = 0; v < n; v++)\n    if (!vis[v] and\
    \ dfs(v, -1, dfs))\n      return {vs, es};\n\n  return {};\n}\n"
  code: "template<bool directed = false>\narray<vector<int>, 2> cycle_detection(vector<array<int,\
    \ 2>> &e) {\n  int n = 0;\n  for(auto [u, v] : e) n = max({n, u + 1, v + 1});\n\
...
layout: document
redirect_from:
- /library/graph/misc/cycle_detection.cpp
- /library/graph/misc/cycle_detection.cpp.html
