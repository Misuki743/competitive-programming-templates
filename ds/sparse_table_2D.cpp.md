...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ds/sparse_table_2D.cpp\"\ntemplate<class T>\nstruct sparse_table_2D\
    \ {\n  vector<vector<vector<vector<T>>>> table;\n  function<T(T, T)> comb;\n \
    \ int size = 0;\n\n  sparse_table_2D(vector<sparse_table<T>> &base, function<T(T,\
  ...
  code: "template<class T>\nstruct sparse_table_2D {\n  vector<vector<vector<vector<T>>>>\
    \ table;\n  function<T(T, T)> comb;\n  int size = 0;\n\n  sparse_table_2D(vector<sparse_table<T>>\
  ...
  verifiedWith: []
documentation_of: ds/sparse_table_2D.cpp
layout: document
redirect_from:
- /library/ds/sparse_table_2D.cpp
- /library/ds/sparse_table_2D.cpp.html
