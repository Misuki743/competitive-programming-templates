...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ds/persistent_treap.cpp\"\nmt19937_64 rng(clock);\nconst\
    \ int TN = 5'000'000;\nstruct Treap {\n  static Treap mem[TN], *pmem;\n  Treap\
    \ *l, *r;\n  char val;\n  int size;\n  Treap() {}\n  Treap(char _val) : l(NULL),\
    \ r(NULL), val(_val), size(1) {}\n}Treap::mem[TN], *Treap::pmem = Treap::mem;\n\
    \nint size(Treap *t) {\n  return t ? t -> size : 0;\n}\nvoid pull(Treap *t) {\n\
  ...
  verifiedWith: []
documentation_of: ds/persistent_treap.cpp
layout: document
redirect_from:
- /library/ds/persistent_treap.cpp
- /library/ds/persistent_treap.cpp.html
