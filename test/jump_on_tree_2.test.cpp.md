...
data:
  ...
  bundledCode: "#line 1 \"test/jump_on_tree_2.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/jump_on_tree\"\
    ...
    \ }\n      for(int v = 0; v < n; v++)\n        if (ok[v])\n          c.eb(v);\n\
    \    }\n    return c;\n  }\n};\n#line 5 \"test/jump_on_tree_2.test.cpp\"\n\nsigned\
  ...
  verifiedWith: []
documentation_of: test/jump_on_tree_2.test.cpp
layout: document
redirect_from:
- /verify/test/jump_on_tree_2.test.cpp
- /verify/test/jump_on_tree_2.test.cpp.html
