...
data:
  ...
  bundledCode: "#line 1 \"test/convolution_1e9+7_2.test.cpp\"\n#define PROBLEM \"\
    ...
    \ namespace NTT;\n#line 6 \"test/convolution_1e9+7_2.test.cpp\"\n\nusing Mint\
    \ = Montgomery_modint<1'000'000'007>;\n\nint main() {\n  ios::sync_with_stdio(false),\
    \ cin.tie(NULL);\n\n  int n, m; cin >> n >> m;\n  vector<Mint> a(n), b(m);\n \
    \ for(Mint &x : a) cin >> x;\n  for(Mint &x : b) cin >> x;\n  cout << convolution_CRT<Mint>(a,\
    \ b) << '\\n';\n\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/convolution_1e9+7_2.test.cpp
layout: document
redirect_from:
- /verify/test/convolution_1e9+7_2.test.cpp
- /verify/test/convolution_1e9+7_2.test.cpp.html
