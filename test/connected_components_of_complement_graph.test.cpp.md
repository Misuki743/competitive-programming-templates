...
data:
  ...
  bundledCode: "#line 1 \"test/connected_components_of_complement_graph.test.cpp\"\
    ...
    \ T b) { return a < b ? a = b, 1 : 0; }\n\n#line 1 \"graph/misc/complement_connectivity.cpp\"\
    \npair<vector<vector<int>>, vector<int>> complement_connectivity(vector<vector<int>>\
  ...
  dependsOn:
  - default/t.cpp
  - graph/misc/complement_connectivity.cpp
