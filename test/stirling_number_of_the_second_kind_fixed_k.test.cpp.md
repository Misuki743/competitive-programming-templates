...
data:
  ...
  bundledCode: "#line 1 \"test/stirling_number_of_the_second_kind_fixed_k.test.cpp\"\
    ...
    \ bool)> fps::dft = ntt.ntt;\n#line 1 \"combi/stirlingSecondCol.cpp\"\n//#include\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/stirling_number_of_the_second_kind_fixed_k\"\
    ...
    ../combi/stirlingSecondCol.cpp\"\n\nsigned main() {\n  ios::sync_with_stdio(false),\
    \ cin.tie(NULL);\n\n  int n, k; cin >> n >> k;\n  cout << stirling_number_second_col<mint>(n\
    \ + 1, k) << '\\n';\n\n  return 0;\n}\n"
  dependsOn:
  - default/t.cpp
  - modint/MontgomeryModInt.cpp
...
layout: document
redirect_from:
- /verify/test/stirling_number_of_the_second_kind_fixed_k.test.cpp
- /verify/test/stirling_number_of_the_second_kind_fixed_k.test.cpp.html
