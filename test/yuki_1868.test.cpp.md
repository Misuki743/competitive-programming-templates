...
data:
  ...
  bundledCode: "#line 1 \"test/yuki_1868.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1868\"\
    ...
    \      }\n    }\n  }\n\n  return pair(dis, pre);\n}\n#line 5 \"test/yuki_1868.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1868\"\n\n#include \"\
    ...
    \ i = 0; i < n - 1; i++)\n    g[i].emplace_back(r[i] + n, 1);\n  for(int i = 0;\
    \ i < n; i++)\n    g[i + n].emplace_back(i, 0);\n  for(int i = n + 1; i < 2 *\
    \ n; i++)\n    g[i].emplace_back(i - 1, 0);\n\n  cout << BFS_01(g, {0}).first[n\
    \ - 1] << '\\n';\n\n  return 0;\n}\n"
  dependsOn:
  - default/t.cpp
  - graph/shortest_path/BFS_01.cpp
  ...
  verifiedWith: []
documentation_of: test/yuki_1868.test.cpp
layout: document
redirect_from:
- /verify/test/yuki_1868.test.cpp
- /verify/test/yuki_1868.test.cpp.html
