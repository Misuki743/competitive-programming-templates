...
data:
  ...
  bundledCode: "#line 1 \"test/yuki_2895.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2895\"\
    ...
    \ T b) { return a < b ? a = b, 1 : 0; }\n\n#line 1 \"linalg/xor_basis_i64.cpp\"\
    ...
    \ x) {\n    i64 v = 0;\n    for(int i = 0; i < W; i++)\n      if (B[i] and (x\
    \ >> i & 1))\n        x ^= B[i], v ^= ids[i];\n    return pair(x == 0, x == 0\
    \ ? v : 0);\n  }\n};\n#line 5 \"test/yuki_2895.test.cpp\"\n\nint main() {\n  ios::sync_with_stdio(false),\
    \ cin.tie(NULL);\n\n  int n; cin >> n;\n  vll a(n);\n  for(ll &x : a)\n    cin\
    \ >> x;\n\n  vi id;\n  xor_basis B;\n  for(int j = -1; ll x : a) {\n    j++;\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2895\"\n\n#include \"\
    ../default/t.cpp\"\n#include \"../linalg/xor_basis_i64.cpp\"\n\nint main() {\n\
  ...
  verifiedWith: []
documentation_of: test/yuki_2895.test.cpp
layout: document
redirect_from:
- /verify/test/yuki_2895.test.cpp
- /verify/test/yuki_2895.test.cpp.html
