...
data:
  ...
  bundledCode: "#line 1 \"test/counting_spanning_tree_directed.test.cpp\"\n#define\
    ...
    \ Mint, bool directed = false>\nMint count_spanning_forest(vector<tuple<int, int,\
    ...
    \    cin >> u >> v;\n    w = 1;\n  }\n\n  cout << count_spanning_forest<mint,\
  ...
  - default/t.cpp
  - modint/Montgomery_modint.cpp
  - linalg/matrix_mint.cpp
  - combi/count_spanning_forest.cpp
