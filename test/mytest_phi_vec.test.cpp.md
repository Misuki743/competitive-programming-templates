...
data:
  ...
  bundledCode: "#line 1 \"test/mytest_phi_vec.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
...
layout: document
redirect_from:
- /verify/test/mytest_phi_vec.test.cpp
- /verify/test/mytest_phi_vec.test.cpp.html
