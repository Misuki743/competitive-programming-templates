...
data:
  ...
  bundledCode: "#line 1 \"test/stirling_number_of_the_first_kind.test.cpp\"\n#define\
    ...
    \ stirling_first_kind<mint>(n) << '\\n';\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/stirling_number_of_the_first_kind\"\
    \n\n#include \"../default/t.cpp\"\n#include \"../modint/Montgomery_modint.cpp\"\
    \n#include \"../poly/NTT.cpp\"\n#include \"../poly/FPS.cpp\"\n#include \"../combi/stirling_first_kind.cpp\"\
    \n\nint main() {\n  ios::sync_with_stdio(false), cin.tie(NULL);\n\n  int n; cin\
    \ >> n;\n  cout << stirling_first_kind<mint>(n) << '\\n';\n\n  return 0;\n}\n"
  dependsOn:
  - default/t.cpp
  - modint/Montgomery_modint.cpp
  - poly/NTT.cpp
  - poly/FPS.cpp
  - combi/stirling_first_kind.cpp
