...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2895
    links:
    - https://yukicoder.me/problems/no/2895
  bundledCode: "#line 1 \"test/yuki_2895_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2895\"\
    ...
    \      cout << tmp << '\\n';\n      return 0;\n    }\n  }\n\n  cout << -1 << '\\\
    n';\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2895\"\n\n#include \"\
  ...
  verifiedWith: []
documentation_of: test/yuki_2895_2.test.cpp
layout: document
redirect_from:
- /verify/test/yuki_2895_2.test.cpp
- /verify/test/yuki_2895_2.test.cpp.html
