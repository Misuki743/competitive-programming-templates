...
data:
  ...
  bundledCode: "#line 1 \"test/point_add_rectangle_sum2.test.cpp\"\n#define PROBLEM\
    ...
    \ x, F f) {\n    if (inv_perms.empty()) {\n      inv_perms = perms;\n      for(auto\
    \ &p : inv_perms)\n        p = invPerm(p);\n    }\n\n    for(int i = 0; i <= H;\
    \ i++)\n      f(i, inv_perms[i][x]);\n  }\n};\n#line 6 \"test/point_add_rectangle_sum2.test.cpp\"\
