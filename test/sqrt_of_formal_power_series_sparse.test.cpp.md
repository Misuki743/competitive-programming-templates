...
data:
  ...
  bundledCode: "#line 1 \"test/sqrt_of_formal_power_series_sparse.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sqrt_of_formal_power_series_sparse\"\
    ...
    \  gd[i] -= gd[i - j] * val;\n        gd[i] *= inv;\n        g[i + 1] = gd[i]\
    \ * bn.inv(i + 1);\n      }\n      return g;\n    }\n  }\n}\n\nusing namespace\
    \ sparse_polynomial_operations;\n#line 10 \"test/sqrt_of_formal_power_series_sparse.test.cpp\"\
  ...
  - combi/binomial.cpp
  - numtheory/sqrt_mod.cpp
  - poly/sparse_polynomial_operations.cpp
...
layout: document
redirect_from:
- /verify/test/sqrt_of_formal_power_series_sparse.test.cpp
- /verify/test/sqrt_of_formal_power_series_sparse.test.cpp.html
