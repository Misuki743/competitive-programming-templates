...
data:
  ...
  bundledCode: "#line 1 \"test/min_plus_convolution_convex_convex.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/min_plus_convolution_convex_convex\"\
    ...
    \ = v[j++];\n      }\n      for(int i = l; i < r; i++)\n        v[i] = tmp[i];\n\
    \    };\n\n    dc(0, ssize(v), dc);\n\n    return f;\n  }\n}\n\nusing namespace\
    \ algorithm_extend;\n#line 1 \"poly/min_plus_convolution_both_convex.cpp\"\n//both\
    \ a and b are convex, i.e. f(i+2) - f(i+1) >= f(i+1) - f(i)\ntemplate<class T>\n\
...
layout: document
redirect_from:
- /verify/test/min_plus_convolution_convex_convex.test.cpp
- /verify/test/min_plus_convolution_convex_convex.test.cpp.html
