...
data:
  ...
  bundledCode: "#line 1 \"segtree/lazy_segment_tree.cpp\"\ntemplate<class M, M(*Mid)(),\
    ...
    \ data;\n  vector<T> tag;\n\n  lazy_segment_tree(int _size) : size(_size), data(2\
    \ * size, Mid()), tag(size, Tid()) {}\n\n  lazy_segment_tree(vector<M> init) :\
...
layout: document
redirect_from:
- /library/segtree/lazy_segment_tree.cpp
- /library/segtree/lazy_segment_tree.cpp.html
