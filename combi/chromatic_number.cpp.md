...
documentation_of: combi/chromatic_number.cpp
layout: document
redirect_from:
- /library/combi/chromatic_number.cpp
- /library/combi/chromatic_number.cpp.html
