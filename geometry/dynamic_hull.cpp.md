...
data:
  ...
  verifiedWith: []
documentation_of: geometry/dynamic_hull.cpp
layout: document
redirect_from:
- /library/geometry/dynamic_hull.cpp
- /library/geometry/dynamic_hull.cpp.html
