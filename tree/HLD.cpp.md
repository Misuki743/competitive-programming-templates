...
data:
  ...
  bundledCode: "#line 1 \"tree/HLD.cpp\"\nstruct HLD {\n  int n, root;\n  vi dep,\
    \ sz, p, head, tin, tout, inv_tin, child_list, c;\n  vc<int32_t> lb;\n\n  inline\
    \ int head_parent(int v) const { return p[head[v]]; }\n\n  HLD(vc<pii> e, int\
    \ _root = 0) : root(_root) { precompute(e); }\n  HLD(vi _p) {\n    vc<pii> e;\n\
    ...
    \ }\n      for(int v = 0; v < n; v++)\n        if (ok[v])\n          c.eb(v);\n\
    \    }\n    return c;\n  }\n};\n"
  code: "struct HLD {\n  int n, root;\n  vi dep, sz, p, head, tin, tout, inv_tin,\
    \ child_list, c;\n  vc<int32_t> lb;\n\n  inline int head_parent(int v) const {\
