...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"acted_monoid/set_max.cpp\"\ntemplate<class U, U unused>\n\
  ...
  code: "template<class U, U unused>\nstruct set_max {\n  using M = U;\n  static M\
    \ Mid() { return numeric_limits<T>::min(); }\n  static M Mop(const M &a, const\
    \ M &b) { return max(a, b); }\n  using T = U;\n  static T Tid() { return unused;\
  ...
  verifiedWith: []
documentation_of: acted_monoid/set_max.cpp
layout: document
redirect_from:
- /library/acted_monoid/set_max.cpp
- /library/acted_monoid/set_max.cpp.html
