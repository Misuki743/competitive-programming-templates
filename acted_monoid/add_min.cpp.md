...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"acted_monoid/add_min.cpp\"\ntemplate<class U>\nstruct add_min\
  ...
  verifiedWith: []
documentation_of: acted_monoid/add_min.cpp
layout: document
redirect_from:
- /library/acted_monoid/add_min.cpp
- /library/acted_monoid/add_min.cpp.html
