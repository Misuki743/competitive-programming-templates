...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"acted_monoid/set_sum.cpp\"\ntemplate<class U, U unused>\n\
    struct set_sum {\n  using M = pair<U, int>;\n  static M Mid() { return make_pair(U(0),\
    ...
    \ M act(const M &a, const T &b) { return b == unused ? a : make_pair(a.second\
    \ * b, a.second); }\n};\n"
  code: "template<class U, U unused>\nstruct set_sum {\n  using M = pair<U, int>;\n\
    ...
    \ T &b) { return b == unused ? a : b; }\n  static M act(const M &a, const T &b)\
    \ { return b == unused ? a : make_pair(a.second * b, a.second); }\n};\n"
  dependsOn: []
  ...
  verifiedWith: []
documentation_of: acted_monoid/set_sum.cpp
layout: document
redirect_from:
- /library/acted_monoid/set_sum.cpp
- /library/acted_monoid/set_sum.cpp.html
